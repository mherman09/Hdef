...
$TEST_BIN_DIR/test_values.sh mom.tmp answer.tmp 1 "mtutil: mij2mom" || exit 1
...
mv j pnt.tmp
$TEST_BIN_DIR/test_values.sh pnt.tmp answer.tmp 12 "mtutil: mij2pnt" || exit 1
...
mv j sdr.tmp
$TEST_BIN_DIR/test_values.sh sdr.tmp answer.tmp 6 "mtutil: mij2sdr" || exit 1
...
mv j sv.tmp
$TEST_BIN_DIR/test_values.sh sv.tmp answer.tmp 6 "mtutil mij2sv" || exit 1

# Moment tensor to ternary representation
echo  0.78904402  0.00248066  0.20847532 > answer.tmp
$BIN_DIR/mtutil -mij 1.4336e+18,-1.3870e+17,-1.2949e+18,4.7140e+17,-1.8573e+18,1.5080e+17 -ternary ternary.tmp
$TEST_BIN_DIR/test_values.sh ternary.tmp answer.tmp 3 "mtutil: mij2ternary" || exit 1
...
$TEST_BIN_DIR/test_values.sh mij.tmp answer.tmp 6 "mtutil: pnt2mij" || exit 1
...
$TEST_BIN_DIR/test_values.sh mom.tmp answer.tmp 1 "mtutil: pnt2mom" || exit 1
...
$TEST_BIN_DIR/test_values.sh sdr.tmp answer.tmp 6 "mtutil: pnt2sdr" || exit 1
...
awk '{if($1<0){print $4,$5,$6,$1,$2,$3}else{print $0}}' sv.tmp > j
mv j sv.tmp
$TEST_BIN_DIR/test_values.sh sv.tmp answer.tmp 6 "mtutil: pnt2sv" || exit 1
...
$TEST_BIN_DIR/test_values.sh ternary.tmp answer.tmp 3 "mtutil: pnt2ter" || exit 1
...
$TEST_BIN_DIR/test_values.sh mij.tmp answer.tmp 6 "mtutil: sdr2mij" || exit 1
...
mv j pnt.tmp
$TEST_BIN_DIR/test_values.sh pnt.tmp answer.tmp 12 "mtutil: sdr2pnt" || exit 1
...
$TEST_BIN_DIR/test_values.sh sdr.tmp answer.tmp 3 "mtutil: sdr2sdr" || exit 1
...
$TEST_BIN_DIR/test_values.sh sv.tmp answer.tmp 3 "mtutil: sdr2sv" || exit 1
