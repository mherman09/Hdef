...
call test_value(mag,6.4182434199195217d0,'mij2mag: mag (dc)')
call mij2mag(mrr,mtt,mpp,mrt,mrp,mtp,mag,'nondc')
call test_value(mag,6.4238638576982652d0,'mij2mag: mag (non-dc)')
...
call test_value(mag,8.4154036748523371d0,'pnt2mag: mag')
call pnt2mag_nondc(pnt,mag)
call test_value(mag,8.4154124278966620d0,'pnt2mag_nondc: mag')
...
call test_value(mom,3.9902490236214116d+019,'mag2mom')
...
call test_value(wid,15.054627009958807d0,'empirical: MB-ss wid')
call test_value(len,38.940363387971708d0,'empirical: MB-ss len')
call empirical(mag,wid,len,'MB','th')
call test_value(wid,25.284245587128211d0,'empirical: MB-th wid')
call test_value(len,32.389183499687725d0,'empirical: MB-th len')
call empirical(mag,wid,len,'MB','no')
call test_value(wid,25.284245587128211d0,'empirical: MB-no wid')
call test_value(len,32.389183499687725d0,'empirical: MB-no len')
call empirical(mag,wid,len,'MB','ot')
call test_value(wid,18.634596787704442d0,'empirical: MB-ot wid')
call test_value(len,37.401584391018623d0,'empirical: MB-ot len')
...
call test_value(wid,42.210451736368604d0,'empirical: YM-ss wid')
call test_value(len,58.277377479636769d0,'empirical: YM-ss len')
call empirical(mag,wid,len,'YM','th')
call test_value(wid,35.307746515410926d0,'empirical: YM-th wid')
call test_value(len,43.193659462830965d0,'empirical: YM-th len')
call empirical(mag,wid,len,'YM','no')
call test_value(wid,35.307746515410926d0,'empirical: YM-no wid')
call test_value(len,43.193659462830965d0,'empirical: YM-no len')
call empirical(mag,wid,len,'YM','ot')
call test_value(wid,39.847400971777475d0,'empirical: YM-ot wid')
call test_value(len,66.522720234738060d0,'empirical: YM-ot len')
